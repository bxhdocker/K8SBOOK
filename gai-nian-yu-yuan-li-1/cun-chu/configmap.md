...
## ConfigMap 创建 <a id="configmap-chuang-jian"></a>

可以使用 `kubectl create configmap` 从文件、目录或者 key-value 字符串创建等创建 ConfigMap。也可以通过 `kubectl create -f file` 创建。

### 从 key-value 字符串创建 <a id="cong-keyvalue-zi-fu-chuan-chuang-jian"></a>
...
### 从 env 文件创建 <a id="cong-env-wen-jian-chuang-jian"></a>
...
### 从目录创建 <a id="cong-mu-lu-chuang-jian"></a>
...
### 从文件 Yaml/Json 文件创建 <a id="cong-wen-jian-yamljson-wen-jian-chuang-jian"></a>
...
## ConfigMap 使用 <a id="configmap-shi-yong"></a>
...
### 用作环境变量 <a id="yong-zuo-huan-jing-bian-liang"></a>
...
### 用作命令行参数 <a id="yong-zuo-ming-ling-hang-can-shu"></a>
...
### 使用 volume 将 ConfigMap 作为文件或目录直接挂载 <a id="shi-yong-volume-jiang-configmap-zuo-wei-wen-jian-huo-mu-lu-zhi-jie-gua-zai"></a>
...
### 使用 subpath 将 ConfigMap 作为单独的文件挂载到目录 <a id="shi-yong-subpath-jiang-configmap-zuo-wei-dan-du-de-wen-jian-gua-zai-dao-mu-lu"></a>
...
* [https://rootsongjc.gitbooks.io/kubernetes-handbook/concepts/configmap.html](https://rootsongjc.gitbooks.io/kubernetes-handbook/concepts/configmap.html)
* [https://kubernetes.feisky.xyz/he-xin-yuan-li/index-2/configmap](https://kubernetes.feisky.xyz/he-xin-yuan-li/index-2/configmap)
