---
description: CRI - Container Runtime Interface（容器运行时接口）
---
...
Container Runtime实现了CRI gRPC Server，包括`RuntimeService`和`ImageService`。该gRPC Server需要监听本地的Unix socket，而kubelet则作为gRPC Client运行。![CRI&#x67B6;&#x6784;-&#x56FE;&#x7247;&#x6765;&#x81EA;kubernetes blog](https://jimmysong.io/kubernetes-handbook/images/cri-architecture.png)图片 - CRI架构-图片来自kubernetes blog
